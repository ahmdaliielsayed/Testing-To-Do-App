...
class TaskDetailFragmentTest {
    ...
    fun activeTaskDetails_DisplayedInUi() = runBlockingTest {
        ...
        launchFragmentInContainer<TaskDetailFragment>(bundle, R.style.Base_AppTheme)*/
        // WHEN - Details fragment launched to display task
        val bundle = bundleOf("taskId" to activeTask.id)
        launchFragmentInContainer<TaskDetailFragment>(bundle, R.style.Base_AppTheme)
    ...
    fun completedTaskDetails_DisplayedInUi() = runBlockingTest {
        ...
        val activeTask = Task("Complete Task", "AndroidX Rocks Completed", true)
        repository.saveTask(activeTask)
        ...
        onView(withId(R.id.task_detail_description_text)).check(matches(isDisplayed()))
        onView(withId(R.id.task_detail_description_text)).check(matches(withText("AndroidX Rocks Completed")))
